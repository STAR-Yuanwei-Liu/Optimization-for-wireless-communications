function [g,h]=noma1_fmin(x,miu,gamma1,gamma2)
...
g=[(2^gamma2-1)*(x(3)*rou0+delta/0.0016*x(2)^2.2/x(6))-x(4)*rou0
(2^gamma1-1)/rou0*delta/0.0018*x(1)^2.2/x(5)-x(3)
%-x(2)^(2.2)*x(5)+x(1)^(2.2)*x(6)
